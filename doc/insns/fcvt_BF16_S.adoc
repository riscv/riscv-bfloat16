...
[NOTE]
====
Converts from BF16 to FP32 cannot cause an underflow exception as the only way to get a subnormal result
is to start with a subnormal input. At most, a conversion will cause an inexact exception.
====
